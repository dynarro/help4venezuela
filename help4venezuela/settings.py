"""
Django settings for help4venezuela project.
...
SECRET_KEY = '#m-+0jl7jw(z*6z+*pg6ex^*zp#!)d77q&e*jaozv7_xy*4gc#'
...
ROOT_URLCONF = 'help4venezuela.urls'
...
WSGI_APPLICATION = 'help4venezuela.wsgi.application'
